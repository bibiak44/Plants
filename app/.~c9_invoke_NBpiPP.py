...
class Plant1(models.Model):
    ...
    kvitnutie_od = models.IntegerField('Kvitnutie od', max_length=30, null=True, blank=True)
    kvitnutie_do = models.CharField('Kvitnutie do', max_length=30, null=True, blank=True)
